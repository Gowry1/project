...
const RecordingHistory: React.FC<RecordingHistoryProps> = ({
  ...
  const highRiskCount = recordings.filter(
    (r) => r.result.percentage_normal > 80
  ).length;
  const moderateRiskCount = recordings.filter(
    (r) => r.result.percentage_normal >= 50 && r.result.percentage_normal <= 80
  ).length;
  const lowRiskCount = recordings.filter(
    (r) => r.result.percentage_normal < 50
  ).length;
  const averageConfidence =
    recordings.length > 0
      ? recordings.reduce((sum, r) => sum + r.result.confidence, 0) /
        recordings.length
      : 0;
                    ...
                    <div className="space-y-3">
                      {dateRecordings.map((recording) => {
                        const percentageNormal =
                          recording.result.percentage_normal;
                        const isHigh = percentageNormal > 80;
                        const isModerate =
                          percentageNormal >= 50 && percentageNormal <= 80;
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                ...
                                <div className="flex items-center">
                                  ...
                                  <div>
                                    ...
                                    <div className="font-medium">
                                      {(
                                        recording.result.confidence * 100
                                      ).toFixed(1)}
                                      %
                                    </div>
                                  </div>
                                ...
                                <div className="flex items-center">
                                  ...
                                  <div>
                                    ...
                                    <div className="font-medium">
                                      {recording.result.normal_count || "N/A"}
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="flex items-center">
                                  ...
                                  <div>
                                    ...
                                    <div className="font-medium">
                                      {(
                                        recording.result.probability * 100
                                      ).toFixed(1)}
                                      %
                                    </div>
                                  </div>
                              ...
                              <div className="mt-4 pt-4 border-t border-gray-100">
                                ...
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-xs">
                                  <div>
                                    ...
                                    <div className="font-medium">
                                      {recording.result.features.jitter.toFixed(
                                        4
                                      )}
                                    </div>
                                  </div>
                                  <div>
                                    ...
                                    <div className="font-medium">
                                      {recording.result.features.shimmer.toFixed(
                                        4
                                      )}
                                    </div>
                                  </div>
                                  <div>
                                    ...
                                    <div className="font-medium">
                                      {recording.result.features.harmonicity.toFixed(
                                        2
                                      )}
                                    </div>
                                  </div>
                                  <div>
                                    ...
                                    <div className="font-medium">
                                      {recording.result.features.pitch.toFixed(
                                        1
                                      )}{" "}
                                      Hz
                                    </div>
                              ...
                              <div className="mt-4">
                                ...
                                <div className="w-full bg-gray-200 rounded-full h-2">
                                  <div
                                    ...
                                    style={{
                                      width: `${recording.result.percentage_normal}%`,
                                    }}
                                  ></div>
                                </div>
                              </div>
